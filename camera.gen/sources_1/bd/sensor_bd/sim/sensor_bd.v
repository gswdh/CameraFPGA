...
(* CORE_GENERATION_INFO = "sensor_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=sensor_bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_clkrst_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "sensor_bd.hwdef" *) 
module sensor_bd
   (ACLK_0,
    ARESETN_0,
    S_AXI_0_araddr,
  ...
  sensor_bd_bit_slip_width_adapt_0_1 bit_slip_width_adapt_0
       (.in_bit(gmax0505_streamer_0_sync_bit_slip_o),
        .out_bus(bit_slip_width_adapt_0_out_bus));
  sensor_bd_gmax0505_streamer_0_0 gmax0505_streamer_0
  ...
  sensor_bd_preserver_0_0 preserver_0
  ...
  sensor_bd_selectio_wiz_0_1 selectio_wiz_0
  ...
  sensor_bd_xlslice_0_0 xlslice_0
       (.Din(axi_gpio_0_gpio_io_o),
        .Dout(xlslice_0_Dout));
  sensor_bd_xlslice_1_0 xlslice_1
       (.Din(axi_gpio_0_gpio_io_o),
        .Dout(xlslice_1_Dout));
  sensor_bd_xlslice_2_1 xlslice_2
