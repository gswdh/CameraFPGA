...
#ifndef _top_xlconcat_0_2_core_h_
#define _top_xlconcat_0_2_core_h_
...
class top_xlconcat_0_2_core : public sc_module 
{
    public: 
       top_xlconcat_0_2_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
    ...
    virtual ~top_xlconcat_0_2_core() = default;
