...
//Date        : Thu Apr 25 14:59:25 2024
//Host        : testserver running 64-bit Ubuntu 20.04.6 LTS
//Command     : generate_target sensor_bd.bd
//Design      : sensor_bd
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* HW_HANDOFF = "sensor_bd.hwdef" *) (* core_generation_info = "sensor_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=sensor_bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_clkrst_cnt=1,synth_mode=None}" *) 
module sensor_bd
   (ACLK_0,
    ARESETN_0,
    S_AXI_0_araddr,
    ...
    sen_ddr_clk_clk_n,
    sen_ddr_clk_clk_p);
  (* x_interface_info = "xilinx.com:signal:clock:1.0 CLK.ACLK_0 CLK" *) (* x_interface_parameter = "XIL_INTERFACENAME CLK.ACLK_0, ASSOCIATED_BUSIF S_AXI_0, ASSOCIATED_RESET ARESETN_0, CLK_DOMAIN sensor_bd_ACLK_0, FREQ_HZ 10000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input ACLK_0;
  ...
  sensor_bd_axi_gpio_0_0 axi_gpio_0
  ...
  sensor_bd_ddr_deserialiser_0_0 ddr_deserialiser_0
       (.data(ddr_deserialiser_0_data),
        .ddr_clk(util_ds_buf_0_IBUF_OUT),
        .ddr_data(util_ds_buf_1_IBUF_OUT));
  sensor_bd_fifo_generator_0_0 fifo_generator_0
       (.din(xlconcat_0_dout),
  ...
  sensor_bd_proc_sys_reset_0_2 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  sensor_bd_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  sensor_bd_xlconstant_1_0 xlconstant_1
       (.dout(xlconstant_1_dout));
  sensor_bd_xlconstant_2_0 xlconstant_2
