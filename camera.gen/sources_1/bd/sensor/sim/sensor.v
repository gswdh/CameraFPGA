...
(* CORE_GENERATION_INFO = "sensor,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=sensor,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=16,numReposBlks=16,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=4,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "sensor.hwdef" *) 
module sensor
   (ACLK_0,
    ARESETN_0,
    S_AXI_0_araddr,
    ...
    texp0,
    texp1);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK_0, ASSOCIATED_BUSIF S_AXI_0:s_axi_lite_sensor_dma:m_axi_sensor_dma, ASSOCIATED_RESET ARESETN_0, CLK_DOMAIN sensor_ACLK_0, FREQ_HZ 10000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input ACLK_0;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axi_sensor_dma, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN sensor_ACLK_0, DATA_WIDTH 256, FREQ_HZ 10000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 1, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 0, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 16, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE WRITE_ONLY, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) output [31:0]m_axi_sensor_dma_awaddr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output [1:0]m_axi_sensor_dma_awburst;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output [3:0]m_axi_sensor_dma_awcache;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output [7:0]m_axi_sensor_dma_awlen;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output [2:0]m_axi_sensor_dma_awprot;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) input m_axi_sensor_dma_awready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output [2:0]m_axi_sensor_dma_awsize;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output m_axi_sensor_dma_awvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output m_axi_sensor_dma_bready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) input [1:0]m_axi_sensor_dma_bresp;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) input m_axi_sensor_dma_bvalid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output [255:0]m_axi_sensor_dma_wdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output m_axi_sensor_dma_wlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) input m_axi_sensor_dma_wready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output [31:0]m_axi_sensor_dma_wstrb;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_sensor_dma " *) output m_axi_sensor_dma_wvalid;
  input ref_clk_i_0;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axi_lite_sensor_dma, ADDR_WIDTH 16, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN sensor_ACLK_0, DATA_WIDTH 32, FREQ_HZ 10000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 0, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [9:0]s_axi_lite_sensor_dma_araddr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) output s_axi_lite_sensor_dma_arready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) input s_axi_lite_sensor_dma_arvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) input [9:0]s_axi_lite_sensor_dma_awaddr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) output s_axi_lite_sensor_dma_awready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) input s_axi_lite_sensor_dma_awvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) input s_axi_lite_sensor_dma_bready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) output [1:0]s_axi_lite_sensor_dma_bresp;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) output s_axi_lite_sensor_dma_bvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) output [31:0]s_axi_lite_sensor_dma_rdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) input s_axi_lite_sensor_dma_rready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) output [1:0]s_axi_lite_sensor_dma_rresp;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) output s_axi_lite_sensor_dma_rvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) input [31:0]s_axi_lite_sensor_dma_wdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) output s_axi_lite_sensor_dma_wready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_lite_sensor_dma " *) input s_axi_lite_sensor_dma_wvalid;
  input tdig0;
  input tdig1;
  output texp0;
  output [0:0]texp1;
  ...
  assign S_AXI_LITE_0_1_ARADDR = s_axi_lite_sensor_dma_araddr[9:0];
  assign S_AXI_LITE_0_1_ARVALID = s_axi_lite_sensor_dma_arvalid;
  assign S_AXI_LITE_0_1_AWADDR = s_axi_lite_sensor_dma_awaddr[9:0];
  ...
  sensor_axis_data_fifo_0_0 axis_data_fifo_0
  ...
  sensor_bus_exapnder_0_0 bus_exapnder_0
  ...
  sensor_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
