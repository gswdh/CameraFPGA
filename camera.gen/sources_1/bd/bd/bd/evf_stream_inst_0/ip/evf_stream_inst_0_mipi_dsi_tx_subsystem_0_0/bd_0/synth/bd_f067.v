...
//--------------------------------------------------------------------------------
//Command: generate_target bd_f067.bd
//Design : bd_f067
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_f067,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_f067,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "evf_stream_inst_0_mipi_dsi_tx_subsystem_0_0.hwdef" *) 
module bd_f067
   (dphy_clk_200M,
    interrupt,
  ...
  bd_f067_axis_data_fifo_0_0 axis_data_fifo_0
  ...
  bd_f067_mipi_dphy_0_0 mipi_dphy_0
  ...
  bd_f067_mipi_dsi_tx_ctrl_0_0 mipi_dsi_tx_ctrl_0
       (.cl_enable(mipi_dsi_tx_ctrl_0_tx_mipi_ppi_if_CL_ENABLE),
        .cl_txrequesths(mipi_dsi_tx_ctrl_0_tx_mipi_ppi_if_CL_TXREQUESTHS),
        ...
        .txbyteclkhs(mipi_dphy_0_txbyteclkhs));
  bd_f067_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  bd_f067_proc_sys_reset_1_0 proc_sys_reset_1
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  bd_f067_util_vector_logic_0_0 util_vector_logic_0
