...
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_2 -period "84" [get_pins "PS7_i/FCLKCLK[2]"]
set_input_jitter clk_fpga_2 2.52
#The clocks are asynchronous, user should constrain them appropriately.#
...
set_property PIO_DIRECTION "INPUT" [get_ports "MIO[39]"]
#  Enet 1 / rxd[3] / MIO[38]
...
set_property PIO_DIRECTION "INPUT" [get_ports "MIO[38]"]
#  Enet 1 / rxd[2] / MIO[37]
...
set_property PIO_DIRECTION "INPUT" [get_ports "MIO[37]"]
#  Enet 1 / rxd[1] / MIO[36]
...
set_property PIO_DIRECTION "INPUT" [get_ports "MIO[35]"]
#  Enet 1 / rx_clk / MIO[34]
